...
<!-- GIF 추가 후 아래 1줄의 주석을 해제하세요. 최상단 히어로 이미지로 노출됩니다.
...
**동작은 [빌드본과 영상](#동작-확인)으로 확인 가능합니다. 이 저장소는 코드와 설계 판단을 읽는 곳입니다.**
...
<!-- GIF 추가 후 아래 2줄의 주석을 해제하세요. ②는 최상단 히어로로 쓰므로 여기서는 ①③만 넣습니다.
